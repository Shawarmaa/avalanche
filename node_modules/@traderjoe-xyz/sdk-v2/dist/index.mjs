...
var LIQUIDITY_HELPER_V2_ADDRESS = {
  [ChainId.FUJI]: "0xA5c68C9E55Dde3505e60c4B5eAe411e2977dfB35",
  [ChainId.AVALANCHE]: "0xA5c68C9E55Dde3505e60c4B5eAe411e2977dfB35",
  [ChainId.ARBITRUM_ONE]: "0xA5c68C9E55Dde3505e60c4B5eAe411e2977dfB35",
  [ChainId.ARB_GOERLI]: "0x0000000000000000000000000000000000000000",
  [ChainId.BNB_CHAIN]: "0x2DAE21762f1eDDd0207188B31Dd72b561C49B587",
  [ChainId.BNB_TESTNET]: "0x0000000000000000000000000000000000000000",
  [ChainId.ETHEREUM]: "0x0000000000000000000000000000000000000000",
  [ChainId.MANTLE]: "0xA5c68C9E55Dde3505e60c4B5eAe411e2977dfB35",
  [ChainId.BERACHAIN]: "0x0000000000000000000000000000000000000000",
  [ChainId.BASE]: "0x0000000000000000000000000000000000000000"
};
...
var getBidAskDistributionFromBinRange = (activeId, binRange, parsedAmounts) => {
  ...
  for (let binId = binRange[0]; binId <= binRange[1]; binId++) {
    let dist_x = BigInt(0);
    let dist_y = BigInt(0);
    const weight = parseEther2(`${Math.abs(binId - activeId) + 1}`);
